...
import { Send, Bot, Loader2, Sparkles, X as XIcon as XIcon, User as UserIcon as UserIcon as UserIcon } from 'lucide-react';
        ...
        <>
          ...
          >
            <Card className="h-full flex flex-col shadow-2xl border-0 bg-white">
              <CardHeader className="flex-shrink-0 bg-gradient-to-r from-[#A2D4F5] to-[#FBC3D2] text-white rounded-t-lg">
