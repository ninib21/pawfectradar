...
import { Upload as UploadIcon as UploadIcon, CheckCircle as CheckCircleIcon as CheckCircleIcon as CheckCircleIcon, FileText, Star as StarIcon as StarIcon as StarIcon, DollarSign as DollarSignIcon as DollarSignIcon as DollarSignIcon, Clock, Shield as ShieldIcon as ShieldIcon as ShieldIcon, AlertCircle } from 'lucide-react';
...
export default function SitterSettings({ user, onSave, saving }) {
  ...
  const getVerificationIcon = (status) => {
    switch (status) {
      ...
      default: return <ShieldIcon className="w-6 h-6 text-gray-400" />;
    }
  };
