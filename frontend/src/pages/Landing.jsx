import { Button as ButtonIcon, CheckCircle as CheckCircleIcon, Heart as HeartIcon, Shield as ShieldIcon, Star as StarIcon } from '@/lib/icons.js';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <ButtonIcon asChild variant="ghost" className="hidden md:inline-flex">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-[#A2D4F5] shadow-2xl relative overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <ButtonIcon size="lg" className="w-full bg-gradient-to-r from-[#A2D4F5] to-[#7DB9E8] hover:opacity-90 text-white shadow-lg">
                  Choose Owner Plus
                </ButtonIcon>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl bg-white relative overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <ButtonIcon size="lg" className="w-full bg-gradient-to-r from-[#FBC3D2] to-[#F8A7C0] hover:opacity-90 text-white shadow-lg">
