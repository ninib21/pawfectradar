import { Heart as HeartIcon, Link as LinkIcon, X as XIcon, useLocation as useLocationIcon } from '@/lib/icons.js';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                <LinkIcon to={createPageUrl("Dashboard")} className="flex items-center gap-3">
