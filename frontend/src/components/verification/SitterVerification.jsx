import { Card as CardIcon, CardContent as CardContentIcon, CardHeader as CardHeaderIcon, CardTitle as CardTitleIcon, CheckCircle as CheckCircleIcon, Heart as HeartIcon, Shield as ShieldIcon, Upload as UploadIcon } from '@/lib/icons.js';
...
export default function SitterVerification({ user, onSave, saving }) {
  ...
  return (
    <div className="space-y-6">
      {/* Sitter Tier Status */}
      <CardIcon className="shadow-lg border-0 bg-gradient-to-r from-blue-50 to-indigo-50">
        <CardHeaderIcon>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitleIcon className="text-xl">Sitter Verification Status</CardTitleIcon>
      ...
      {formData.id_document_url && formData.selfie_match_url && user?.verification_status === 'not_requested' && (
        <CardIcon className="shadow-lg border-2 border-[#A2D4F5]">
          <CardContentIcon className="p-6 text-center">
