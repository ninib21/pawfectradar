import { Card as CardIcon, CardContent as CardContentIcon, CardHeader as CardHeaderIcon, CardTitle as CardTitleIcon, CheckCircle as CheckCircleIcon, DollarSign as DollarSignIcon, Shield as ShieldIcon, Star as StarIcon, Upload as UploadIcon } from '@/lib/icons.js';
  ...
  if (user?.user_type === "owner") {
    return (
      <CardIcon className="shadow-lg border-0">
        <CardContentIcon className="text-center py-16">
