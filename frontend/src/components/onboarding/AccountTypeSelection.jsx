import { Card as CardIcon, CardContent as CardContentIcon, CardHeader as CardHeaderIcon, CardTitle as CardTitleIcon, CheckCircle as CheckCircleIcon } from '@/lib/icons.js';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {getCurrentPlans().map((plan) => (
          ...
          >
            ...
            <CardHeaderIcon className="text-center pb-6 pt-8 px-8 relative z-10">
              ...
              <CardTitleIcon className="text-2xl font-bold mb-2">{plan.title}</CardTitleIcon>
            ...
            <CardContentIcon className="px-8 pb-8 relative z-10 flex flex-col flex-grow">
      ...
      {formData.selected_plan && (
        <CardIcon className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 border-2">
          <CardContentIcon className="p-8">
