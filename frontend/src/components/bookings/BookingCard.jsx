import { Calendar as CalendarIcon, Card as CardIcon, CardContent as CardContentIcon, CardHeader as CardHeaderIcon, CheckCircle as CheckCircleIcon, MapPin as MapPinIcon, User as UserIcon } from '@/lib/icons.js';
...
export default function BookingCard({ booking, currentUser, onClick, onAction }) {
  ...
  return (
    <CardIcon className="hover:shadow-lg transition-all duration-300 cursor-pointer border-0 bg-gradient-to-r from-white to-gray-50/50" onClick={onClick}>
