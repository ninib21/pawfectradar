import { Card as CardIcon, CardContent as CardContentIcon, Search as SearchIcon } from '@/lib/icons.js';
...
export default function EmptyBookings({ status, userType }) {
  ...
  return (
    <CardIcon className="border-2 border-dashed border-gray-200 bg-gradient-to-br from-gray-50/50 to-white">
      <CardContentIcon className="flex flex-col items-center justify-center py-16 text-center">
