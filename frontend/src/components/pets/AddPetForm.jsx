import { Card as CardIcon, CardContent as CardContentIcon, CardHeader as CardHeaderIcon, CardTitle as CardTitleIcon, X as XIcon } from '@/lib/icons.js';
...
export default function AddPetForm({ pet, onSubmit, onCancel, isEditing = false }) {
  ...
  return (
    <CardIcon className="mb-8 shadow-lg border-0 bg-gradient-to-br from-white to-blue-50/30">
      <CardHeaderIcon>
